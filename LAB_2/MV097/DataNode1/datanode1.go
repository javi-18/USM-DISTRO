...
func (s *server) escritura(informacion []Data) error {
	archivo, err := os.OpenFile("/app/INFO_1.txt", os.O_WRONLY|os.O_CREATE|os.O_APPEND, 0644)
	if err != nil {
...
func (s *server) Mensaje(ctx context.Context, msg *pb.Solicitud) (*pb.Respuesta, error) {
	...
	return &pb.Respuesta{Resultado: "Datos recibidos y escritos en INFO_1.txt"}, nil
}
...
func main() {
	...
	log.Println("Servidor escuchando en el puerto :5002")
